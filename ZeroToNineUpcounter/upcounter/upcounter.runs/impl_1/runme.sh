...
HD_PWD='C:/Users/user/upcounter/upcounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log upcounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source upcounter.tcl -notrace
